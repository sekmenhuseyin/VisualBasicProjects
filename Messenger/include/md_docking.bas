...
'Deactivate Docking
Public Sub DockingTerminate(FormName As Form)
...
'Activate Docking
Public Sub DockingStart(ByVal FormName As Form, Optional ByVal IsMaster As Boolean = False)
    ...
    For t = 0 To LogCount - 1
        If Logs(t).hwnd = FormName.hwnd Then
    ...
    If IsMaster Then m_hMasterWnd = FormName.hwnd
